...
def preprocess_df(df,text_column='text',target_column='target'):
    ...
    """
    try:
        logger.debug('starting pre-processing of dataframe')
...
def main(text_column='text',target_column='target'):
    ...
    try:
        ...
        #transform the data
        train_processed_data=preprocess_df(df=train_data,text_column=text_column,target_column=target_column)
        test_processed_data=preprocess_df(df=test_data,text_column=text_column,target_column=target_column)
